...
export class PostDetailPage extends React.Component {
  ...
  renderPostForm = () => {
    return ( <
      ...
      /> <
      a className = { styles['post-submit-button'] } href = "#"
      onClick = { this.handleEditPost } > < FormattedMessage id = "submit" / > < /a> < /
      div >
    );
  };
  ...
  render() {
    return ( <
        ...
        /> <
        a className = { styles['edit-post-button'] } href = "#"
        onClick = { this.props.toggleEditPost } > < FormattedMessage id = "editPost" / > < /a> {
